        ...
        <div v-if="isShow" class="vehicle-panel">
                ...
                <div class="number-panel-row">
                    ...
                    >
                        <!-- <image
                            ...
                            >删除</image
                        > -->
                        <i class="iconfont icon-deleteicon vehicle-en-button-delete"></i>
                    </div>
                </div>
            </div>
            <!--英文键盘  -->
            <block class="letter-panel-box" v-if="keyBoardType == 1">
                ...
                <div class="vehicle-panel-row">
                    ...
                    >
                        <!-- <img :src="require('@/assets/image/delete.png')" class="vehicle-en-button-delete" /> -->
                        <i class="iconfont icon-deleteicon vehicle-en-button-delete"></i>
                    </div>
                </div>
                <div class="vehicle-panel-row-last">
                    ...
                    <div class="vehicle-panel-row-button vehicle-panel-ok" @click="vehicleTap('ok')" data-value="ok">
                        确认
                    </div>
                </div>
            </block>
