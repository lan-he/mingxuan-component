    ...
    <div class="spell-img">
        <div class="left-menu">
            ...
            <div class="left-menu-bottom">
                <div class="container-mini" v-for="(item, index) in isData.items" :key="index">
                    <div v-for="(item, index) in isData.items" :key="index" :style="item" class="item item-1"></div>
        ...
        <div class="right-menu">
            <div class="container" id="container">
                <div v-for="(item, index) in isData.items" :key="index" :style="item" class="item item-1">
                    <span>+</span>
                </div>
                <div class="drag-line" id="dragLine">
                    <div class="drag-line-center"></div>
    ...
    methods: {
        drag() {
            ...
            oDragIcon.onmousedown = function (ev) {
                ...
                var oPanelWidthList = getComputedStyle(oPanel, null)['gridTemplateColumns'].split('px')
                ...
                document.onmousemove = function (ev) {
                    ...
                    oPanelWidthLists = getComputedStyle(oPanel, null)['gridTemplateColumns'].split('px')
